...
def main():
    ...
    parser.add_argument("--seqlen", type=int, default=512, help="sequence length of calibration data samples.")
    ...
    if args.wbits < 16 or args.abits <16:
        ...
        cache_dataloader = f'{args.cache_dir}/dataloader_{args.model_family}_{args.calib_dataset}_{args.nsamples}sample_seqlen{args.seqlen}.cache'
